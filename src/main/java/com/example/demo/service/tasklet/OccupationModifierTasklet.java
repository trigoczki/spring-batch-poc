...
@Component
public class OccupationModifierTasklet implements Tasklet {

  private final PersonService personService;

  public OccupationModifierTasklet(PersonService personService) {
  ...
  public @Nullable RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext)
    ...
    person.setOccupation(person.getOccupation() + "_modified");
